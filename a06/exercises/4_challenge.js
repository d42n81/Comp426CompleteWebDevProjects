...
export async function getTwoHeroesSolution(heroData, hero1Id, hero2Id) {
  let heroToReturn = {hero1: undefined, hero2: undefined};
  getHeroByIdAsync(heroData, hero1Id).then(hero => heroToReturn.hero1 = hero);
  getHeroByIdAsync(heroData, hero2Id).then(hero => heroToReturn.hero2 = hero);
  return heroToReturn;
